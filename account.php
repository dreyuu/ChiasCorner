...
<head>
    ...
    <title> Chia's Corner Account </title>
...
<div class="container">
    ...
    <div class="table-container">
        ...
        <table border="1" id="userTable">
            ...
            <tr>
                <td contenteditable="false">Marcus Julian D. Jimeno</td>
                <td contenteditable="false">092242</td>
                <td contenteditable="false">marcus.pogi12@gmail.com</td>
                <td contenteditable="false">Waiter</td>
                <td>
                    <button class="action-btn edit-btn" onclick="editRow(this)">Edit</button>
                    <button class="action-btn" onclick="removeRow(this)">Remove</button>
                </td>
            </tr>
        </table>
    </div>
